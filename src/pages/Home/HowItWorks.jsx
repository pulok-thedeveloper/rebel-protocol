...
const HowItWorks = () => {
  ...
  return (
    <div id="how" className=" bg-black relative px-20 overflow-hidden -z-10">
      ...
      ></div>
      <video
        className="absolute h-full object-cover top-0 -left-[12%]"
      ...
      />
      <div className="relative flex justify-end items-center py-40">
          ...
          {data?.map((item) => (
            ...
            >
              ...
              <footer className="flex-grow flex items-end uppercase">
                <p className="border-t pt-5 w-full text-rebel_primary">{item.moto}</p>
              </footer>
            </div>
          ))}
        </div>
